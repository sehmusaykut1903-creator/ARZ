...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F9] flex overflow-hidden transition-all duration-500" 
      ...
      >
        {/* Header */}
        <header className="h-16 md:h-20 bg-app-card/80 backdrop-blur-2xl border-b border-app-border px-4 md:px-8 flex items-center justify-between shadow-[0_1px_3px_rgba(0,0,0,0.02)] shrink-0 z-40 sticky top-0 transition-all duration-300">
          <div className="flex items-center gap-4 md:gap-8">
            ...
            {!isMobile && <div className="h-8 w-[1px] bg-gray-200 hidden lg:block" />}
          ...
          <div className="flex items-center gap-2 sm:gap-6">
            ...
            <div className="relative">
              <button 
                ...
                className={`p-2 md:p-3 rounded-2xl transition-all relative ${showNotifications ? 'bg-primary text-app-on-primary shadow-lg' : 'text-app-muted hover:text-app-text hover:bg-gray-100'}`}
              >
                <Bell size={18} />
            ...
            <button 
              ...
              className="p-2 md:p-3 rounded-2xl text-red-500 hover:text-red-700 hover:bg-red-50 transition-all shrink-0 cursor-pointer"
            >
              <LogOut size={18} />
            </button>
